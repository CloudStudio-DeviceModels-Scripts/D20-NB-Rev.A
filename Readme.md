...
# Parsing + Configuration Script – D20-NB - Rev. A

This **Parsing + Configuration** script is designed for the **D20-NB** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – D20-NB Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **D20-NB** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
